    ...
    const getRoommateDetails = async () => {
      try {
        const res = await axios.get(
          `http://localhost:5000/roommateLists/${id}`
        );
    ...
    <>
      ...
      <div className="w-11/12 mx-auto lg:flex border-2 border-black mt-3 rounded-lg">
        <div className="lg:w-[50%]">
          <img
            src="https://homeid-elementor-demo7.g5plus.net/wp-content/uploads/2022/12/home-bg-01.jpg"
            alt=""
        ...
        <div className="lg:w-[50%] grid grid-cols-1 md:grid-cols-2  h-[500px] ">
          <div className="bg-cover overflow-hidden relative border-2 border-black">
            <img
              src="https://i.ibb.co/3ykNgd3/t-2.jpg"
              alt=""
          ...
          <div className="bg-cover overflow-hidden relative border-2 border-black">
            <img
              src="https://i.ibb.co/vY2xbF0/t-3.jpg"
              alt=""
              className="w-full h-full transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-125  duration-300"
            />
          </div>
          <div className="bg-cover overflow-hidden relative border-2 border-black">
            <img
              src="https://i.ibb.co/JBQym2Z/t-4.jpg"
              alt=""
              className="w-full h-full transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-125  duration-300"
            />
          </div>
          <div className="bg-cover overflow-hidden relative border-2 border-black">
            <img
              src="https://i.ibb.co/grcfNkP/t-1.jpg"
              alt=""
              className="w-full h-full transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-125  duration-300"
            />
                  ...
                  <div className="mb-5 flex justify-around">
                    ...
                    <div>
                      <h2 className="lg:text-xl font-medium text-black">
                        User Name:{" "}
                        {
                          roommateDetails[0]?.roomateList.contactPerson
                            .firstName
                        }{" "}
                        {roommateDetails[0]?.roomateList.contactPerson.lastName}
                      </h2>
                      <h2 className="lg:text-xl font-medium text-black">
                        Home type:{" "}
                        {
                          roommateDetails[0]?.roomateList.description
                            .bedroomType
                        }
                      </h2>
                      <p className="text-black  font-medium inline-block md:text-lg mt-1">
                        Location:{" "}
                        {
                          roommateDetails[0]?.roomateList.description.location
                            .address
                        }
                        ,{" "}
                        {
                  ...
                  <div className="border-t-4 border-b-4">
                    ...
                    <ul className="mb-8 lg:text-lg  text-black">
                      <li>
                        - Gender & Sexuality :{" "}
                        {
                          roommateDetails[0]?.roomateList.roomatePreferences
                            .gender
                        }{" "}
                      </li>
                      <li>
