                                ...
                                <div>
                                 ...
                                 transition-all duration-500 capitalize items-center flex justify-center gap-5">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor"
                                            d="m19.23 15.26l-2.54-.29a1.99 1.99 0 0 0-1.64.57l-1.84 1.84a15.045 15.045 0 0 1-6.59-6.59l1.85-1.85c.43-.43.64-1.03.57-1.64l-.29-2.52a2.001 2.001 0 0 0-1.99-1.77H5.03c-1.13 0-2.07.94-2 2.07c.53 8.54 7.36 15.36 15.89 15.89c1.13.07 2.07-.87 2.07-2v-1.73c.01-1.01-.75-1.86-1.76-1.98" /></svg>
                                        +88 01923456781321
                                    </button>
                                </div>
                            </div>
                            <div
                                className="md:w-[416px] max-w-[416px] h-fit p-5 underline flex justify-center items-center gap-5"  >
                        ...
                        <Link key={index} to="/flatDetails/:id" className="block">
                            <div key={index} className="px-4 py-8 shadow-lg max-w-[350px] font-sans rounded-xl space-y-6 my-5 mx-auto bg-white">
                                <div className="flex justify-center w-full h-48 lg:h-[280px] relative">
                                    ...
                                    <img className="rounded-lg bg-black/40 w-full h-full" src={flat.image} alt="card navigate ui" />
                                </div>
