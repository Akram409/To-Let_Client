    ...
    return (
        <div className='px-12 flex gap-10'>
            ...
            <div className="flex border border-black rounded-lg">
                <Link to="/">
                    <button
                        className={`px-4 py-2 rounded-lg mr-2 w-44 ${activeButton === 'sublet' ? 'bg-green-400 text-black font-semibold border border-black' : 'bg-white text-black font-semibold'}`}
                ...
                <Link to="/findRoommate">
                    <button
                        className={`px-4  py-2 rounded-lg w-44 ${activeButton === 'roommate' ? 'bg-green-400 text-black font-semibold border border-black' : 'bg-white text-black font-semibold'}`}
