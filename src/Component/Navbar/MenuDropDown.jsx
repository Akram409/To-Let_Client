        ...
        <div className="relative">
            <div className="flex flex-row items-center gap-3">
             ...
             {isOpen &&(
                ...
                {user ? <>
                    <Link to="/wishlist" className="px-4 py-3 hover:bg-neutral-100 transition font-semibold">
                    Wishlist
                </Link>
                <Link to="/myAccount" className="px-4 py-3 hover:bg-neutral-100 transition font-semibold">
                   My Account
                </Link>
                <Link to="/myListing" className="px-4 py-3 hover:bg-neutral-100 transition font-semibold">
                   My Listing
                </Link>
                <div
                 onClick={logOut} 
